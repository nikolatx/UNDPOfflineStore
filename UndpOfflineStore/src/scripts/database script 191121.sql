...
(1, 'AM4 APU 220GE, 3.4GHz BOX', 2, 1, 32, '6890.00', 'AM4_APU_220GE_34Box.jpg', 1),
(2, 'Intel LGA1151 i3-9100F 3.6GHZ', 1, 1, 25, '11890.00', 'intel_i3_9100F_36B.jpg', 1),
...
--
ALTER TABLE `faktura`
  MODIFY `faktura_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `prijemnica`
  MODIFY `prijemnica_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
